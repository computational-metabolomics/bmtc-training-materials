...
- Download R from the [CRAN website](https://www.r-project.org/).
- Run the .exe file that was just downloaded
- Go to the [RStudio download page](https://posit.co/download/rstudio-desktop)
- Under Installers select RStudio x.yy.zzz - Windows 11 (where x, y, and z represent version numbers).
...
- It is also a good idea to install XQuartz (needed by some packages)
- Go to the [RStudio download page](https://posit.co/download/rstudio-desktop)
- Under Installers select RStudio x.yy.zzz (where x, y, and z represent version numbers) for your Linux distro.
- Double click the file to install RStudio
- Once it’s installed, open RStudio to make sure it works and you don’t get any error messages.
...
Compare your R version to the version listed [here](https://www.bioconductor.org/install/) for the current release. **The current release of Bioconductor is version 3.23; it works with R version 4.6.0.**
